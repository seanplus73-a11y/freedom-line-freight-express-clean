...
export default function GilbertDelivery() {
  const businessSchema = {
    ...
    url: "https://www.flfreightco.com/gilbert-delivery",
    ...
    description:
      "Direct drive-away vehicle pickup and delivery service in Gilbert, AZ. Cars, SUVs, and small trucks that run and drive. No trailers, no towing. Same-day available depending on route and schedule.",
  ...
  const serviceSchema = {
    ...
    areaServed: { "@type": "City", name: "Gilbert" },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Gilbert Delivery Services",
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Car Drive-Away Service Gilbert",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Dealer Vehicle Delivery Gilbert",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Auto Parts Delivery Gilbert",
          },
        },
      ],
    },
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do you offer same-day vehicle delivery in Gilbert?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Same-day vehicle pickup and delivery in Gilbert, AZ may be available depending on distance, schedule, and route availability. Text 480-742-8553 for current availability.",
        },
      },
      {
        "@type": "Question",
        name: "Do you use trailers or tow trucks in Gilbert?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What types of vehicles do you transport in Gilbert?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  return (
    <>
      <Helmet>
        <title>
          Vehicle Pickup and Delivery Gilbert AZ | Freedom Line Freight Express
        </title>
        <meta
          name="description"
          content="Gilbert AZ vehicle pickup and delivery. Direct drive-away service for cars, SUVs, and small trucks that run and drive. No towing, no trailers. Same-day available depending on route."
        />
        <link rel="canonical" href="https://www.flfreightco.com/gilbert-delivery" />
        <meta property="og:title" content="Vehicle Pickup and Delivery in Gilbert AZ" />
        <meta
          property="og:description"
          content="Direct drive-away service for vehicles in Gilbert. No towing. No trailers. Fast, reliable, owner-operated service."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.flfreightco.com/gilbert-delivery" />
      ...
      <main className="min-h-screen bg-[#0b0f19] text-white overflow-hidden">
        <section className="bg-[#f97316] text-black text-center py-2 text-sm font-semibold">
          Gilbert same-day pickup available depending on schedule and route
        </section>
        ...
        <header className="relative overflow-hidden border-b border-white/10 px-6 py-24">
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <p className="max-w-4xl text-lg text-gray-400 mb-6">
              Freedom Line Freight Express provides direct drive-away service for cars, SUVs, and small trucks in Gilbert. If it runs and drives, I can help move it from dealer to home, auction to shop, repair shop to customer, or across town.
            </p>

            <p className="max-w-4xl text-gray-400 mb-10">
              Serving Gilbert areas including Downtown Gilbert, Agritopia, Power Ranch, Morrison Ranch, Val Vista Lakes, Seville, and nearby routes to Chandler, Mesa, Queen Creek, San Tan Valley, and Phoenix.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Get Gilbert Quote in 5 to 10 Minutes
            ...
            <div className="grid items-start gap-12 lg:grid-cols-2">
              <div>
                <p className="text-[#f97316] font-bold uppercase tracking-widest mb-3">
                  Gilbert drive-away service
                </p>

                <h2 className="mb-6 text-3xl md:text-5xl font-extrabold leading-tight">
                  Fast Gilbert Vehicle{" "}
                  <span className="text-[#f97316]">Drive-Away Service</span>
                </h2>

                <p className="mb-4 text-gray-300 text-lg">
                  Need a car moved from Downtown Gilbert, a repair shop, dealership, auction pickup, or private seller?
                </p>
                ...
                <p className="text-gray-400">
                  Most local Gilbert deliveries start around $85 depending on distance, route, service type, and schedule availability.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
                Who Uses Gilbert Vehicle Delivery?
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className={cardClass}>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Quick Gilbert pickups, dependable scheduling, and clear text updates from pickup to drop off.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
                  More Local Delivery Options in Gilbert
                </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className={cardClass}>
                  ...
                  <p className="text-gray-400">
                    Gilbert to Chandler, Mesa, Queen Creek, San Tan Valley, or Phoenix.
                  </p>
                </div>
        ...
        <section className="border-y border-white/10 bg-[#111827] py-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mx-auto max-w-3xl space-y-6">
              {[
                {
                  q: "Do you offer same-day vehicle delivery in Gilbert?",
                ...
                {
                  q: "Do you use trailers or tow trucks in Gilbert?",
                ...
                {
                  q: "What types of vehicles do you transport in Gilbert?",
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid items-start gap-12 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mb-6 text-3xl md:text-5xl font-extrabold">
                  Serving <span className="text-[#f97316]">Gilbert</span> and the East Valley
                </h2>

                <p className="mb-4 text-gray-300 text-lg">
                  Based in San Tan Valley, I run in Gilbert and nearby communities including Downtown Gilbert, Agritopia, Power Ranch, Morrison Ranch, Val Vista Lakes, Seville, and nearby Gilbert routes.
                </p>

                <p className="text-gray-400 mb-8">
                  Need a vehicle, auto parts, package, or documents moved in or around Gilbert? I handle scheduled pickups and urgent same-day requests when available.
                </p>
              ...
              <div className={cardClass}>
                <h2 className="mb-6 text-2xl font-bold text-[#f97316]">
                  Request a Gilbert Quote
                </h2>

                <p className="mb-6 text-gray-300">
                  Get a fast quote for vehicle pickup and delivery in Gilbert AZ. Most quotes are reviewed quickly when you send the pickup and drop off details.
                </p>
            ...
            <div className="mx-auto mt-16 max-w-4xl rounded-2xl border border-white/10 bg-[#111827] p-8">
              <h2 className="mb-4 text-center text-2xl font-bold text-white">
                Gilbert Arizona Service Map
              </h2>

              <p className="mb-6 text-center text-gray-400">
                Direct drive-away service throughout Gilbert and surrounding East Valley communities.
              </p>
        ...
        <section className="relative bg-[#f97316] py-24 text-center overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-5">
              Need a Vehicle Delivered in Gilbert?
            </h2>
