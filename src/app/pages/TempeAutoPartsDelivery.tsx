...
export default function TempeAutoPartsDelivery() {
  return (
    <div className="bg-[#0f172a] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        <div
          ...
          style={{
            backgroundImage: "url('/images/tempe-auto-parts.jpg')",
          }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 text-4xl font-bold leading-tight md:text-6xl">
              Auto Parts Delivery Service in Tempe AZ
            </h1>

            <p className="mb-6 text-lg leading-8 text-gray-200">
              Fast and reliable auto parts delivery for repair shops, dealerships,
              suppliers, and local businesses in Tempe. Same day and scheduled
              delivery available across Tempe and nearby areas.
            </p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.25fr_0.95fr]">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              <h2 className="mb-4 text-2xl font-bold text-orange-400 md:text-3xl">
                Fast Local Auto Parts Delivery in Tempe
              </h2>
              ...
              <p className="mb-4 leading-7 text-gray-300">
                ...
                auto parts between suppliers, shops, dealerships, and customers in Tempe.
              </p>

              <p className="mb-4 leading-7 text-gray-300">
                If you are searching for auto parts delivery near me in Tempe,
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 max-w-4xl">
            <h2 className="mb-4 text-2xl font-bold text-orange-400 md:text-3xl">
              Local Auto Parts Courier Service in Tempe
            </h2>

            <p className="mb-5 leading-7 text-gray-300">
              Businesses in Tempe often lose time when parts are delayed between a supplier,
            ...
            <p className="mb-5 leading-7 text-gray-300">
              ...
              and local business customers who need dependable delivery for auto parts in Tempe.
            ...
            <p className="leading-7 text-gray-300">
              Nearby service areas include Phoenix, Mesa, Chandler, Gilbert, Scottsdale,
              Queen Creek, and San Tan Valley. Many customers in these areas use our Tempe
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="leading-8 text-gray-300">
                ...
                Queen Creek, San Tan Valley, and surrounding Valley areas.
              </p>
            </div>
      ...
      <section className="border-t border-white/10 pb-16">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="mb-8 text-center text-3xl font-bold md:text-4xl">
            Tempe Auto Parts Delivery FAQ
          </h2>

          <div className="grid gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="text-xl font-bold text-orange-400">
                Do you offer auto parts delivery in Tempe?
              </h3>
              <p className="mt-3 leading-7 text-gray-300">
                Yes. I provide direct local auto parts delivery throughout Tempe and nearby areas.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="rounded-3xl bg-orange-500 px-8 py-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">
              Need Auto Parts Delivered in Tempe
            </h2>
