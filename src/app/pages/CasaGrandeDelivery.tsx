...
export default function CasaGrandeDelivery() {
  const businessSchema = {
    ...
    url: "https://www.flfreightco.com/casa-grande-delivery",
    ...
    description:
      "Direct drive-away vehicle pickup and delivery service in Casa Grande, AZ. Cars, SUVs, and small trucks that run and drive. No trailers, no towing. Same-day available depending on route and schedule.",
  ...
  const serviceSchema = {
    ...
    areaServed: { "@type": "City", name: "Casa Grande" },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Casa Grande Delivery Services",
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Car Drive-Away Service Casa Grande",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Dealer Vehicle Delivery Casa Grande",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Auto Parts Delivery Casa Grande",
          },
        },
      ],
    },
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Do you offer same-day vehicle delivery in Casa Grande?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Same-day vehicle pickup and delivery in Casa Grande, AZ may be available depending on distance, schedule, and route availability. Text 480-742-8553 for current availability.",
        },
      },
      {
        "@type": "Question",
        name: "Do you use trailers or tow trucks in Casa Grande?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "What types of vehicles do you transport in Casa Grande?",
        acceptedAnswer: {
          "@type": "Answer",
  ...
  return (
    <>
      <Helmet>
        <title>
          Vehicle Pickup and Delivery Casa Grande AZ | Freedom Line Freight Express
        </title>
        <meta
          name="description"
          content="Casa Grande AZ vehicle pickup and delivery. Direct drive-away service for cars, SUVs, and small trucks that run and drive. No towing, no trailers. Same-day available depending on route."
        />
        <link rel="canonical" href="https://www.flfreightco.com/casa-grande-delivery" />
        <meta property="og:title" content="Vehicle Pickup and Delivery in Casa Grande AZ" />
        <meta
          property="og:description"
          content="Direct drive-away service for vehicles in Casa Grande. No towing. No trailers. Fast, reliable, owner-operated service."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.flfreightco.com/casa-grande-delivery" />
      ...
      <main className="min-h-screen bg-[#0b0f19] text-white overflow-hidden">
        <section className="bg-[#f97316] text-black text-center py-2 text-sm font-semibold">
          Casa Grande same-day pickup available depending on schedule and route
        </section>
        ...
        <header className="relative overflow-hidden border-b border-white/10 px-6 py-24">
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <p className="max-w-4xl text-lg text-gray-400 mb-6">
              Freedom Line Freight Express provides direct drive-away service for cars, SUVs, and small trucks in Casa Grande. If it runs and drives, I can help move it from dealer to home, auction to shop, repair shop to customer, or across town.
            </p>

            <p className="max-w-4xl text-gray-400 mb-10">
              Serving Casa Grande areas including Downtown Casa Grande, Mission Royale, Villago, Ironwood Village, Casa Grande Airport area, and nearby routes to Eloy, Coolidge, Maricopa, Florence, Phoenix, and Tucson.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Get Casa Grande Quote in 5 to 10 Minutes
            ...
            <div className="grid items-start gap-12 lg:grid-cols-2">
              <div>
                <p className="text-[#f97316] font-bold uppercase tracking-widest mb-3">
                  Casa Grande drive-away service
                </p>

                <h2 className="mb-6 text-3xl md:text-5xl font-extrabold leading-tight">
                  Fast Casa Grande Vehicle{" "}
                  <span className="text-[#f97316]">Drive-Away Service</span>
                </h2>

                <p className="mb-4 text-gray-300 text-lg">
                  Need a car moved from a Casa Grande repair shop, dealership, private seller, auction pickup, or customer address?
                </p>
                ...
                <p className="text-gray-400">
                  Casa Grande routes may include longer travel time, so pricing depends on distance, schedule, route direction, and pickup availability.
                </p>
              </div>

              <div className={cardClass}>
                <h2 className="mb-6 text-2xl font-bold text-[#f97316]">
                  Casa Grande Services
                </h2>
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
                Who Uses Casa Grande Vehicle Delivery?
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className={cardClass}>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Scheduled Casa Grande pickups, dependable routing, and clear text updates from pickup to drop off.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold mb-6 leading-tight">
                  More Local Delivery Options in Casa Grande
                </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className={cardClass}>
                  ...
                  <h3 className="font-bold text-lg mb-2">Regional Routes</h3>
                  <p className="text-gray-400">
                    Casa Grande to Phoenix, Chandler, Queen Creek, Maricopa, Coolidge, or Tucson.
                  </p>
                </div>
        ...
        <section className="border-y border-white/10 bg-[#111827] py-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mx-auto max-w-3xl space-y-6">
              {[
                {
                  q: "Do you offer same-day vehicle delivery in Casa Grande?",
                  a: "Same-day and next-day delivery may be available depending on distance, schedule, and route availability. Text 480-742-8553 with pickup and drop off addresses for the fastest quote.",
                },
                {
                  q: "Do you use trailers or tow trucks in Casa Grande?",
                ...
                {
                  q: "What types of vehicles do you transport in Casa Grande?",
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid items-start gap-12 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mb-6 text-3xl md:text-5xl font-extrabold">
                  Serving <span className="text-[#f97316]">Casa Grande</span> and nearby routes
                </h2>

                <p className="mb-4 text-gray-300 text-lg">
                  Based in San Tan Valley, I run Casa Grande delivery routes including Downtown Casa Grande, Mission Royale, Villago, Ironwood Village, Casa Grande Airport area, and nearby regional routes.
                </p>

                <p className="text-gray-400 mb-8">
                  Need a vehicle, auto parts, package, or documents moved in or around Casa Grande? I handle scheduled pickups and urgent same-day requests when available.
                </p>
              ...
              <div className={cardClass}>
                <h2 className="mb-6 text-2xl font-bold text-[#f97316]">
                  Request a Casa Grande Quote
                </h2>

                <p className="mb-6 text-gray-300">
                  Get a fast quote for vehicle pickup and delivery in Casa Grande AZ. Most quotes are reviewed quickly when you send the pickup and drop off details.
                </p>
            ...
            <div className="mx-auto mt-16 max-w-4xl rounded-2xl border border-white/10 bg-[#111827] p-8">
              <h2 className="mb-4 text-center text-2xl font-bold text-white">
                Casa Grande Arizona Service Map
              </h2>

              <p className="mb-6 text-center text-gray-400">
                Direct drive-away service throughout Casa Grande and nearby regional routes.
              </p>

              <div className="overflow-hidden rounded-xl border border-white/10">
                <iframe
                  title="Casa Grande Arizona Map"
                  src="https://www.google.com/maps?q=Casa%20Grande,AZ&output=embed"
                  width="100%"
                  height="400"
                  style={{ border: 0 }}
                  loading="lazy"
        ...
        <section className="relative bg-[#f97316] py-24 text-center overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-5">
              Need a Vehicle Delivered in Casa Grande?
            </h2>
