    ...
    <div className="bg-[#0f172a] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        <div
          ...
          style={{
            backgroundImage: "url('/images/phoenix-delivery.jpg')",
          }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.18em] text-orange-400">
              Phoenix Arizona Delivery Service
            </p>

            <h1 className="mb-6 text-4xl font-bold leading-tight md:text-6xl">
              Vehicle Pickup and Delivery Service in Phoenix AZ
            </h1>

            <p className="mb-6 text-lg leading-8 text-gray-200">
              Need someone to move your car in Phoenix without using a tow truck
            ...
            <p className="mb-8 text-base leading-8 text-gray-300 md:text-lg">
              ...
              business transport across Phoenix and the East Valley. Fast local
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 max-w-3xl">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">
              Delivery Services Available in Phoenix
            </h2>
            <p className="leading-8 text-gray-300">
              I provide direct local delivery for vehicles, auto parts, small
              packages, and business items across Phoenix. Simple service, clear
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-7">
              ...
              <p className="leading-7 text-gray-300">
                ...
                dealership, family member, or new location in Phoenix.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-7">
              ...
              <p className="text-sm leading-6 text-gray-400">
                Best for metro Phoenix area transport
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="leading-8 text-gray-300">
                Serving Phoenix, Mesa, Gilbert, Chandler, Queen Creek, San Tan
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="rounded-3xl bg-orange-500 px-8 py-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">
              Need delivery service in Phoenix today
            </h2>
