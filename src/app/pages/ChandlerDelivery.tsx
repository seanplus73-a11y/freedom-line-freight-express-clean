          ...
          <div className="mx-auto max-w-6xl px-6 py-14">
            <div className="grid items-start gap-10 md:grid-cols-2">
              <div>
                ...
                <p className="mb-4 text-neutral-300">
                  We serve customers in Chandler and nearby communities
