        ...
        <section>
          <div className="mx-auto max-w-6xl px-6 py-14 grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mb-4 text-neutral-300">
                We serve Queen Creek and nearby areas including San Tan Valley,
                Gilbert, Mesa, Chandler, Florence, and the greater East Valley.
              </p>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <p className="mb-4 text-neutral-300">
                Need fast vehicle pickup and delivery in Queen Creek, AZ?
