      ...
      <main className="min-h-screen bg-neutral-950 text-white">
          ...
          <div className="mx-auto max-w-6xl px-6 py-14 grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mb-4 text-neutral-300">
                Need a car moved across San Tan Valley, picked up from a
        ...
        <section>
          <div className="mx-auto max-w-6xl px-6 py-14 grid gap-10 md:grid-cols-2">
            <div>
              <h2 className="mb-4 text-2xl font-bold text-orange-400">
                San Tan Valley Service Area
              </h2>

              <p className="mb-4 text-neutral-300">
                We serve San Tan Valley and nearby areas including Queen Creek,
                Florence, Gilbert, Mesa, Chandler, and surrounding East Valley
                communities.
              </p>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <p className="mb-4 text-neutral-300">
                Need fast vehicle pickup and delivery in San Tan Valley, AZ?
