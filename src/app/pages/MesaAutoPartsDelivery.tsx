    ...
    <div className="bg-[#0f172a] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        <div
          ...
          style={{
            backgroundImage: "url('/images/mesa-auto-parts.jpg')",
          }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 text-4xl font-bold leading-tight md:text-6xl">
              Auto Parts Delivery Service in Mesa AZ
            </h1>

            <p className="mb-6 text-lg leading-8 text-gray-200">
              Fast and reliable auto parts delivery for repair shops, dealerships,
              suppliers, and local businesses in Mesa. Same day and scheduled
              delivery available across Mesa and nearby areas.
            </p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.25fr_0.95fr]">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              <h2 className="mb-4 text-2xl font-bold text-orange-400 md:text-3xl">
                Fast Local Auto Parts Delivery in Mesa
              </h2>
              ...
              <p className="mb-4 leading-7 text-gray-300">
                ...
                auto parts between suppliers, shops, dealerships, and customers in Mesa.
              </p>

              <p className="mb-4 leading-7 text-gray-300">
                If you are searching for auto parts delivery near me in Mesa,
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 max-w-4xl">
            <h2 className="mb-4 text-2xl font-bold text-orange-400 md:text-3xl">
              Local Auto Parts Courier Service in Mesa
            </h2>

            <p className="mb-5 leading-7 text-gray-300">
              Businesses in Mesa often lose time when parts are delayed between a supplier,
            ...
            <p className="mb-5 leading-7 text-gray-300">
              ...
              and local business customers who need dependable delivery for auto parts in Mesa.
            ...
            <p className="leading-7 text-gray-300">
              Nearby service areas include Gilbert, Chandler, Queen Creek, San Tan Valley, Phoenix,
              and Scottsdale. Many customers in these areas use our Mesa auto parts delivery
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="leading-8 text-gray-300">
                Serving Mesa, Gilbert, Chandler, Queen Creek, San Tan Valley, Phoenix,
      ...
      <section className="border-t border-white/10 pb-16">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="mb-8 text-center text-3xl font-bold md:text-4xl">
            Mesa Auto Parts Delivery FAQ
          </h2>

          <div className="grid gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="text-xl font-bold text-orange-400">
                Do you offer auto parts delivery in Mesa?
              </h3>
              <p className="mt-3 leading-7 text-gray-300">
                Yes. I provide direct local auto parts delivery throughout Mesa and nearby areas.
              </p>
            </div>
